...
The backend must implement the aligned `openapi.yaml` contract, support deterministic local development, expose predictable request/response schemas and be testable by the QA agent. The MVP database decision is covered separately by ADR 0007.
