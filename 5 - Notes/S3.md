...
| ------------------------------------ | ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **S3 Standard**                      | 99.99%       | General purpose; high throughput, low latency; for frequently accessed data. ==big data, mobile, gaming app, content distribution==                             |
| **S3 Intelligent-Tiering**           | 99.9%        | Automatically moves data between tiers based on usage; **no retrieval fees**.                                                                                   |
| **Standard-IA**. (Infrequent Access) | 99.9%        | for data that is **less frequent accessed**, but requires rapid access; lower storage cost but has a **retrieval fee**; for backups/DR.                         |
| **One Zone-IA** (Infrequent Access)  | 99.5%        | for data that is **less frequent accessed**, but requires rapid access.  Stored in a **single AZ**; 20% cheaper than Standard-IA; data lost if AZ is destroyed. |
